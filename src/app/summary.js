export default function Summary() {
    return (
        <div className="relative h-screen flex flex-col justify-center items-center max-h-[85vh]">
            <div className="w-[85vw] -mt-[10vh] max-h-fit flex flex-col justify-center items-center bg-[rgba(255,255,255,0.1)] backdrop-blur-md p-10 shadow-md rounded-md">
                ...
                <p className="text-left text-sm font-normal text-white mb-4">
